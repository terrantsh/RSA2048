...
Date        : 2018-9-11 16:35:55
Description : 基本实现了RSA2048加密解密的各项功能，并能够进行最大256位的加密操作
*****************************************************************************/
#include <stdio.h>
#include <string.h>
#include <time.h>
...
static int RSA2048(void)
{
    ...
    rsa_sk_t sk = {0};
    uint8_t output[256];
    uint8_t input [256] = { 0x21,0x55,0x53,0x53,0x53,0x53,0x53,0x53,0x53,0x53,0x53,0x53,0x53,0x53,0x53,
